...
namespace YiFlag.Tools
{
    public static class HttpHelper
    {
        ...
        /// <returns></returns>
        public static string GetHttpHelper(string urlString)
        {
        ...
        /// <returns></returns>
        public static string PostHttpHelper(string url,string param)
        {
            string strURL = url;
            ...
            System.Net.HttpWebResponse response; response = (System.Net.HttpWebResponse)request.GetResponse();
            System.IO.Stream s;
